...
6. Help & Support`;
    ...
    static getAccountManagementMenu() {
...
2. TV Subscription`;
    ...
    static getErrorMessage(message = 'Invalid input. Please try again.') {
        return {
            sessionId: '',
            message,
    ...
    static getConfirmationMessage(prompt) {
        return {
            sessionId: '',
            message: prompt,
            continueSession: true
